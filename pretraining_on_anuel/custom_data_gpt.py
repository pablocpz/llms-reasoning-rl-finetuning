...
# CURRENT hyperparameters--> the model is overfitting and not generalizing well the anuel aaa lyrics
...
# with open('alternative-input.txt', 'r', encoding='utf-8') as f:
#     text = f.read()
...
@torch.no_grad()
def estimate_loss(model): #passing model as param instead
    out = {}
    model.eval()
